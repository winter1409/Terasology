 ...
 * @author Immortius
 */
public class StateFrontierLoading implements GameState {

    private static final Logger logger = LoggerFactory.getLogger(StateFrontierLoading.class);
    ...
    public StateFrontierLoading(WorldInfo worldInfo) {
