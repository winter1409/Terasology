 ...
 * @version 0.1
 */
public class StateFrontierSinglePlayer implements GameState {

    private static final Logger logger = LoggerFactory.getLogger(StateFrontierSinglePlayer.class);
    ...
    public StateFrontierSinglePlayer() {
